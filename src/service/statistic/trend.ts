const expenseTrend = async (req: any, res: Response) => {
  return {
    trend: [
...
const balanceTrend = async (req: any, res: Response) => {
  return {
    trend: [
...
const expenseHistogram = async (req: any, res: Response) => {
  return {
    expense: [
      29.9, 4, 42.45, 656.58, 0, 10.11, 34.8, 227, 6.04, 99.37, 14.48, 150.92,
      10.11, 1.6, 4, 6, 83.32, 748.89, 44.68, 43.19, 0, 69.48, 0, 0, 114, 0, 0,
      26.2, 460.51, 65.42, 388.44
    ]
  }
}
